  ...
  <div className='sm:flex sm:flex-col md:flex md:flex-row md:justify-start sm:justify-center md:gap-5'>
    ...
    <div className='pt-5 sm:pb-5'>
      <ul className='flex flex-col sm:flex-col md:flex-row gap-0'>
        ...
        <li className='border-l-[1px] md:border-r-[1px] md:border-[#a2a2a2] px-5 text-[18px]'><a href="#children" className='sm:text-[12px] md:text-[16px] text-[#757575] hover:text-[#a6a6a6]'>Children</a></li>
        <li className='md:border-l-[1px] md:border-[#a2a2a2] sm:border-l-0 px-5 text-[18px]'><a href="#grocery" className='sm:text-[12px] text-[#757575] md:text-[16px] hover:text-[#a6a6a6]'>Grocery</a></li>
      </ul>
    </div>
  </div>
</nav>
