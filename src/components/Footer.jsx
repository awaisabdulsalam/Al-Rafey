    ...
    <footer className="sm:py-20 sm:px-[10px] bg-[#f6f6f6] mt-[-30px] pt-20 pb-10 md:py-20">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="sm:text-[12px] md:text-[14px]  font-normal text-gray-500 mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, libero. Ea fugit tenetur quaerat sint dicta quo ipsam molestiae ad?</p>
